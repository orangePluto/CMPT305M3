...
public class TableController {
    ...
    void searchPress(ActionEvent event) {
		...
		} else if (!(neighField.getText().isEmpty())) { //Query by neigh or
			if (dropBox.getValue() != null)				//assessment class
    ...
    public void initialize() {
        URL url = getClass().getResource("/Property_Assessment_Data.csv");
	...
	private void filterByNeighAssem(String neigh, String assem) {
		...
		if (assem != null) { //Query by neighbourhood and assessment class
